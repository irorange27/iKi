...
const BUILTIN_DARK_THEME: ThemeSlotPalette = {
  ...
  bgHover: '#3a3d45',
  bgActive: '#4e5256',
  surfaceInsetHighlight: 'inset 0 1px 0 rgba(255, 255, 255, 0.04)',
  surfaceShadowSm: '0 2px 8px rgba(0, 0, 0, 0.18)',
  surfaceShadowMd: '0 8px 20px rgba(0, 0, 0, 0.18)',
  surfaceShadowLg: '0 24px 56px rgba(0, 0, 0, 0.34)',
  textPrimary: '#ffffff',
...
const BUILTIN_LIGHT_THEME: ThemeSlotPalette = {
  ...
  bgHover: '#e5e7eb',
  bgActive: '#dbeafe',
  surfaceInsetHighlight: 'inset 0 1px 0 rgba(255, 255, 255, 0.72)',
  surfaceShadowSm: '0 2px 6px rgba(148, 163, 184, 0.1)',
  surfaceShadowMd: '0 8px 20px rgba(148, 163, 184, 0.12)',
  surfaceShadowLg: '0 22px 48px rgba(148, 163, 184, 0.18)',
  textPrimary: '#111827',
