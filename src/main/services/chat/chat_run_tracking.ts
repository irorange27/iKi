...
import { normalizeWhitespace, sanitizePromptMetadataText, toIsoNow } from '../../../shared/utils/text';
import type { ToolStreamEvent } from './chat_types';
...
export type AgentRunTracker = {
  ...
  recordToolEvent: (event: ToolStreamEvent) => void;
...
export const createAgentRunTracker = (
  ...
  let currentRun = createAgentRun({
    ...
    parentRunId: normalizeWhitespace(params.parentRunId) || null,
    rootRunId: normalizeWhitespace(params.parentRunId) || runId,
