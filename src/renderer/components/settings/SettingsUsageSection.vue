<template>
  <section class="config-section usage-section">
    <div class="settings-card">
      <div class="usage-toolbar">
        ...
        <label class="input-label usage-period-select">
          ...
          <select v-model="usagePeriod">
            <option v-for="option in usagePeriodOptions" :key="option.value" :value="option.value">
              {{ option.label }}
            </option>
          </select>
        </label>
      ...
      <div v-else-if="usageLoading" class="usage-empty">Loading usage...</div>
    ...
    <div class="settings-card">
      ...
      <div v-if="usageLoading" class="usage-empty">Loading heatmap...</div>
    ...
    <div class="settings-card">
      ...
      <div v-if="usageLoading" class="usage-empty">Loading chart...</div>
