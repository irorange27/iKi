...
export const en = defineCatalog({
  ...
  'chat.reasoning.thought': 'Thought process',
  ...
  'chat.sidebar.noResults': 'No matching chats',
  'chat.sidebar.messageMatches': 'In messages',
  'chat.sidebar.newChat': 'New chat',
  'chat.sidebar.newTask': 'New task',
  'chat.sidebar.grouping': 'Grouping',
  'chat.sidebar.groupByTime': 'Recent',
  'chat.sidebar.groupByProjects': 'Projects',
  'chat.sidebar.automations': 'Automations',
  'chat.sidebar.running': 'Run in progress',
  'chat.sidebar.showMore': ({ count }) => `Show more (${count})`,
  'chat.sidebar.showLess': 'Show less',
  'time.justNow': 'Just now',
  'time.minutes': ({ count }) => `${count}m ago`,
  'time.hours': ({ count }) => `${count}h ago`,
  'time.days': ({ count }) => `${count}d ago`,
  'chat.sidebar.deleteChat': 'Delete chat',
  'chat.sidebar.exportChat': 'Export as Markdown',
  'chat.turnPreview.jump': 'Preview and jump to this turn',
  'chat.turnPreview.empty': 'No messages yet',
  'chat.turnPreview.roleUser': 'You',
  'chat.turnPreview.roleAssistant': 'Assistant',
  ...
  'chat.copy.label': 'Copy',
  'chat.copy.copied': 'Copied',
  'chat.regenerate.label': 'Regenerate',
  ...
  'chat.runs.trace.reasoning': 'Reasoning',
  'chat.runs.trace.observation': 'Observation',
  ...
  'chat.runs.status.queued': 'Queued',
  'chat.runs.status.running': 'Running',
  'chat.runs.status.blocked': 'Blocked',
  'chat.runs.status.completed': 'Completed',
  'chat.runs.status.failed': 'Failed',
  'chat.runs.status.cancelled': 'Cancelled',
  'chat.runs.trajectory': 'Trajectory',
  'chat.runs.trace.loading': 'Loading trajectory...',
  'chat.runs.trace.empty': 'No steps recorded',
  'chat.runs.trace.steps': ({ count }) => `${asCount(count)} steps`,
  ...
  'chat.input.permission.title': 'Tool permission mode',
  'chat.input.permission.ask': 'Ask first',
  'chat.input.permission.auto': 'Auto-approve',
  'chat.input.permission.panelTitle': 'How should tools be approved?',
  'chat.input.permission.defaultName': 'Global default',
  'chat.input.permission.defaultDesc': 'Follow the global auto-approve setting',
  'chat.input.permission.alwaysName': 'Ask for approval',
  'chat.input.permission.alwaysDesc': 'Always ask before running tools',
  'chat.input.permission.trustName': 'Approve for me',
  'chat.input.permission.trustDesc': 'Only ask for actions classified as risky',
  'chat.input.permission.fullName': 'Full access',
  'chat.input.permission.fullDesc': 'Run tools without asking',
  'chat.input.permission.alwaysChip': 'Ask first',
  'chat.input.permission.trustChip': 'Approve for me',
  'chat.input.permission.fullChip': 'Full access',
  'chat.input.permission.askTitle': 'Permission: tools ask before running. Click to auto-approve all tool requests.',
  'chat.input.permission.autoTitle': 'Permission: all tool requests are auto-approved. Click to require approval again.',
  'chat.input.workNeedsWorkspace': 'This task needs a project workspace — pick one in the composer before sending.',
  ...
  'chat.workspace.worktreeMerge': 'Merge into main checkout',
  'chat.workspace.worktreeMergeTitle':
  ...
  'chat.workspace.worktreeMergeFailed': ({ error }) => `Merge failed: ${asText(error)}`,
  ...
  'chat.sessionStats.roundsSteps': ({ rounds, steps }) =>
    `${asText(rounds)} rounds · ${asText(steps)} steps`,
  'chat.sessionStats.llmTime': ({ time }) => `LLM ${asText(time)}`,
  'chat.sessionStats.toolTime': ({ time }) => `Tools ${asText(time)}`,
  'chat.sessionStats.firstTokenAvg': ({ time }) => `First token avg ${asText(time)}`,
  'chat.sessionStats.tokensPerSecond': ({ speed }) => `${asText(speed)} tok/s`,
  'chat.sessionStats.cacheHit': ({ percent }) => `Cache hit ${asText(percent)}%`,
  'chat.sessionStats.inputTokens': ({ tokens }) => `Input ${asText(tokens)} tok`,
  'chat.sessionStats.outputTokens': ({ tokens }) => `Output ${asText(tokens)} tok`,
  'chat.sessionStats.tooltip.toolCalls': ({ count }) =>
    `${asText(count)} tool call${asText(count) === '1' ? '' : 's'}`,
  'chat.sessionStats.tooltip.reasoningTokens': ({ tokens }) =>
    `Reasoning tokens: ${asText(tokens)}`,
  'chat.sessionStats.tooltip.cacheWriteTokens': ({ tokens }) =>
    `Cache write: ${asText(tokens)} tok`,
  'chat.sessionStats.tooltip.cost': ({ cost }) => `Estimated cost: $${asText(cost)}`,
  'toolCall.approvalRequest': 'Tool Approval Request',
  'toolCall.approve': 'Approve',
  'toolCall.reject': 'Reject',
  'toolCall.resultTag': 'Tool Result',
  'toolCall.callTag': 'Tool Call',
  'toolCall.mcpServer': ({ name }) => `MCP Server: ${asText(name)}`,
  'toolCall.references': 'References',
  'toolCall.output': 'Output',
  'toolCall.diff': 'Changes',
  'toolCall.callId': 'Call ID',
  'toolCall.arguments': 'Arguments',
  'toolCall.expandDetails': 'Expand tool details',
  'toolCall.collapseDetails': 'Collapse tool details',
  'toolCall.command': 'Command',
  'toolCall.query': 'Query',
  'toolCall.url': 'URL',
  'toolCall.task': 'Task',
  'toolCall.path': 'Path',
  'toolCall.executionPlan': 'Execution Plan',
  'toolCall.todoList': 'Todo List',
  'toolCall.todoLists': 'Todo lists',
  'toolCall.input': 'Input',
  'toolCall.allTodoLists': 'All todo lists',
  ...
  'toolCall.meta.timeout': ({ value }) => `timeout: ${asText(value)} ms`,
  'toolCall.meta.limit': ({ value }) => `limit: ${asText(value)}`,
  'toolCall.meta.maxChars': ({ value }) => `maxChars: ${asText(value)}`,
  'toolCall.meta.tools': ({ value }) => `tools: ${asText(value)}`,
  'toolCall.meta.maxIterations': ({ value }) => `maxIterations: ${asText(value)}`,
  'toolCall.meta.recursive': ({ value }) => `recursive: ${asText(value)}`,
  'toolCall.meta.encoding': ({ value }) => `encoding: ${asText(value)}`,
  'toolCall.state.running': 'Running',
  'toolCall.state.queued': 'Queued',
  'toolCall.state.awaitingApproval': 'Awaiting approval',
  ...
  'toolCall.state.done': 'Done',
  'toolCall.group.verb.read': 'Read',
  'toolCall.group.verb.edit': 'Edited',
  'toolCall.group.verb.write': 'Wrote',
  'toolCall.group.verb.delete': 'Deleted',
  'toolCall.group.verb.run': 'Ran',
  'toolCall.group.verb.search': 'Searched',
  'toolCall.group.verb.fetch': 'Fetched',
  'toolCall.group.verb.agent': 'Agent',
  'toolCall.group.verb.skill': 'Skill',
  'toolCall.group.verb.plan': 'Plan',
  'toolCall.group.verb.call': 'Call',
  'toolCall.group.files': ({ count }) => `${asCount(count)} files`,
  'toolCall.group.calls': ({ count }) => `${asCount(count)} calls`,
  ...
  'settings.network.proxy.description':
    'Configure a proxy path for web requests when your current network cannot reach the public internet directly.',
  ...
  'settings.network.proxy.usernameOptional': 'Username (optional)',
  'settings.network.proxy.usernamePlaceholder': 'proxy-user',
  'settings.network.proxy.passwordOptional': 'Password (optional)',
  'settings.network.proxy.passwordPlaceholder': 'Leave empty when authentication is not required',
  'settings.network.proxy.authHint':
    'Fill in username and password only when your SOCKS5 or HTTP proxy requires authentication.',
  'settings.network.proxy.validationHost': 'Enter a proxy host before running the test.',
  'settings.network.proxy.validationPort': 'Enter a valid proxy port between 1 and 65535.',
  'settings.network.proxy.summaryDirect': 'Direct connection',
  'settings.network.proxy.summaryIncomplete': 'Proxy details incomplete',
  ...
  'settings.network.diagnostics.testAction': 'Test Connection',
  'settings.network.diagnostics.successTitle': 'Network ready',
  'settings.network.diagnostics.partialTitle': 'Partial connectivity',
  'settings.network.diagnostics.failedTitle': 'Connection failed',
  'settings.network.diagnostics.summaryAllPassed': ({ passed, total, route }) =>
    `${asCount(passed)} of ${asCount(total)} checks passed. ${asText(route)}`,
  'settings.network.diagnostics.summaryPartial': ({ passed, total, route }) =>
    `Only ${asCount(passed)} of ${asCount(total)} checks passed. ${asText(route)}`,
  'settings.network.diagnostics.summaryNonePassed': ({ route }) =>
    `No checks passed. ${asText(route)}`,
  ...
  'settings.network.diagnostics.route': ({ route }) => `Route: ${asText(route)}`,
