import type { ChatServicePlatformDeps, ChatCompanionBridge, ContinuityRetrievalPayload } from '@iki/backend/chat_platform';
import { noopCompanionBridge } from '@iki/backend/chat_platform';
